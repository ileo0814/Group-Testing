...
if(getwd()=="C:/Users/Leo/Documents"){
  ...
  path2 = "C:/Users/Leo/OneDrive/huangleo Leo Huang/USC Files/2022 Spring (Current)/BIOS 890 Independent Study/results/DT_Areal/"
}
...
if(n.size!= 1){
  stop("This R script is for IT only; the sim.id entered is not for IT")
}
